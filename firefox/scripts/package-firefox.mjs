...
try {
  ...
  await new Promise((resolve, reject) => {
    const child = spawn(command, ["build", "--source-dir", buildSource.sourceDirectory, "--artifacts-dir", artifactsDirectory, "--ignore-files", "native-host/**", "native-host/", "scripts/**", "scripts/"], {
      stdio: "inherit",
    })
  ...
  console.log(`Firefox source commit: ${buildSource.sourceCommit}`)
