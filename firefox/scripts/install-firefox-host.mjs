...
const LAUNCHER_PATH = resolve(homedir(), ".local/share/omp-send-context", `${HOST_NAME}-host`)
...
export function createHostLauncher(nodePath = process.execPath, hostPath = HOST_PATH) {
